    ...
    <div className=' bg-white text-secondary text-sm'>
      <div className='mx-12 pb-16'>
        ...
        <p className='mt-4 text-left text-secondary-green-dark'>
          ...
          titularidad de Gaha-Aranda C.I.F. BXXXXXXX y domicilio social en Calle
          Eúfrates, 12 41020 Sevilla denominado DATOS WEB cuya finalidad
          principal es PERMITIR LA RECOGIDA DE DATOS MEDIANTE LA WEB PARA AYUDAR
          AL INTERESADO A DISPONER DE INFORMACIÓN DE LO QUE NECESITE., teniendo
          implementadas todas las medidas de seguridad establecidas en dichos
          Decretos mencionados anteriormente.
        </p>
        <p className='mt-4 text-left text-secondary-green-dark'>
          El envío de datos de carácter personal es obligatorio para contactar y
          recibir información sobre los servicios prestados por Gaha-Aranda.
        ...
        <p className='mt-4 text-left text-secondary-green-dark'>
          El Usuario que envía la información a Gaha-Aranda es el único
        ...
        <p className='mt-4 text-left text-secondary-green-dark'>
          Gaha-Aranda no responde de la veracidad de las informaciones que no
          sean de elaboración propia y de las que indique otra fuente, por lo
          ...
          exonera a Gaha-Aranda de responsabilidad ante cualquier daño o
        ...
        <p className='mt-4 text-left text-secondary-green-dark'>
          Gaha-Aranda NO CEDERÁ los datos personales a terceros. No obstante, en
        ...
        <p className='mt-4 text-left text-secondary-green-dark'>
          ...
          dirección Calle Eúfrates, 12 41020 Sevilla o a través de correo
          electrónico a info@gaha-aranda.com junto con prueba válida en derecho,
          como fotocopia del NIF e indicando en el asunto PROTECCIÓN DE DATOS.
        </p>
        <p className='mt-4 text-left text-secondary-green-dark'>
          ...
          PROTECCIÓN DE DATOS{' '}
          <Link
            aria-label='Ir a agencia española de protección de datos'
            to='https://www.aepd.es/'>
            www.agpd.es
          </Link>
        </p>
        <h2 className='mt-10 text-xl text-primary font-bold'>
        ...
        <p className='mt-4 text-left text-secondary-green-dark'>
          ...
          tratamiento de los mismos por parte de Gaha-Aranda, en la forma y para
          las finalidades indicadas en la presente Política de Protección de
          Datos Personales.
        </p>
        <h2 className='mt-10 text-xl text-primary font-bold'>
        ...
        <p className='mt-4 text-left text-secondary-green-dark'>
          Gaha-Aranda se reserva el derecho a modificar la presente política
          para adaptarla a novedades legislativas o jurisprudenciales, así como
          a prácticas de la industria. En dichos supuestos, Gaha-Aranda
